  ...
  $(document).ready(function() {
    const addCopyButton = function() {
      $("pre").each(function(index) {
        ...
        const buttonStyle =
          "color:#ffffff;cursor: pointer;display: flex;justify-content: flex-end;align-items: center;background-color:#173077;padding: 0.5rem 1rem;width:100%;text-align:right;font-size: .75rem;line-height: 1rem;border-bottom-left-radius: 0.375rem;border-bottom-right-radius: 0.375rem;border-top-left-radius: 0; border-top-right-radius: 0;";
