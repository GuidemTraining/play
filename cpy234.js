$(document).ready(function(){
  const add_copy_btn = function(){
    $("pre").each(function(index) {
     ...
     var button_style = "color: #ffffff; cursor: pointer; display: flex; align-items: center; background-color: #173077; padding: 0.5rem 0.8rem; min-width: 100px; max-width: 120px; text-align: center; font-size: 0.9rem; line-height: 1.2rem; border-radius: 0.375rem; margin-left: auto;";
