$(document).ready(function(){
  const add_copy_btn = function(){
    $("pre").each(function(index) {
     ...
     var button_style = "color: #ffffff; cursor: pointer; display: flex; align-items: center; background-color: #FF0000; padding: 0.5rem 1rem; width: 120px; text-align: right; font-size: .75rem; line-height: 1rem; border-top-left-radius: 0rem; border-top-right-radius: 0rem; border-bottom-left-radius: 0.375rem; border-bottom-right-radius: 0.375rem; margin-left: auto;";
